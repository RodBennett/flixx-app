...
async function displayPopularMovies() {
    ...
    results.forEach((popularMovie) => {
      ...
      <div class="card-body">
        ...
        <p class="card-text">
          <small class="text-muted">Released: ${popularMovie.release_date
            } </small>
        </p>
      </div>
    `;
...
async function displayPopularShows() {
  ...
  />`
    ...
    <div class="card-body">
          ...
          <p class="card-text">
            <small class="text-muted">First Aired: ${popularTVshow.first_air_date
            }</small>
          </p>
        </div>
`;
...
/>`
  ...
  <div class="details-bottom">
    ...
    <h4>Production Companies</h4>
    ${show.production_companies.map((company) => `<div class="list-group">${company.name}</div>`).join("")}
  </div>
</div>
`;
